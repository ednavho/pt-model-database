...
export type LineageNode = {
  ...
  verified?: boolean;
  source?: string;
  date?: string;       // human-readable display: "July 2023", "Founded 2020", "Born ~1991"
  year?: number;       // numeric year for timeline sorting
  links?: { label: string; url: string }[];
  photoUrl?: string;   // for person/org nodes
};
...
export const lineageNodes: LineageNode[] = [
  ...
  // ── Models ───────────────────────────────────────────────────────────────
  {
    ...
    date: '2024', year: 2024,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/RunDiffusion/Juggernaut-X-Hyper' }],
  },
  {
    id: 'control_lora_depth', label: 'control-lora-depth', type: 'model', verified: true,
    date: '2023', year: 2023,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/stabilityai/control-lora' }],
  },
  {
    id: 'pseudocomfy', label: 'pseudocomfy nodes', type: 'model', verified: true,
    date: '2024', year: 2024,
    links: [{ label: 'GitHub', url: 'https://github.com/pseudotools/pseudocomfy' }],
  },
  {
    id: 'sdxl_base', label: 'SD XL base 1.0', type: 'model', verified: true,
    date: 'July 2023', year: 2023,
    links: [
      { label: 'HuggingFace', url: 'https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0' },
      { label: 'GitHub', url: 'https://github.com/Stability-AI/generative-models' },
    ],
  },
  {
    id: 'sdxl_refiner', label: 'SD XL refiner 1.0', type: 'model', verified: true,
    date: 'July 2023', year: 2023,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/stabilityai/stable-diffusion-xl-refiner-1.0' }],
  },
  {
    id: 'albedobase', label: 'albedobaseXL v21', type: 'model', verified: true,
    date: '2023', year: 2023,
    links: [{ label: 'CivitAI', url: 'https://civitai.com/models/140737/albedobase-xl' }],
  },
  {
    id: 'realvisxl', label: 'realvisxlV50', type: 'model', verified: true,
    date: '2024', year: 2024,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/SG161222/RealVisXL_V5.0_Lightning' }],
  },
  {
    id: 'aiangelmix', label: 'aiAngelMix v30', type: 'model', verified: false,
    date: '2023', year: 2023,
    links: [{ label: 'CivitAI', url: 'https://civitai.com/models/119229' }],
  },
  {
    id: 'clip_bigg', label: 'CLIP-ViT-bigG-14', type: 'model', verified: true,
    date: '2022', year: 2022,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/laion/CLIP-ViT-bigG-14-laion2B-39B-b160k' }],
  },
  {
    id: 'clip_h', label: 'CLIP-ViT-H-14', type: 'model', verified: true,
    date: '2022', year: 2022,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/laion/CLIP-ViT-H-14-laion2B-s32B-b79K' }],
  },
  {
    id: 'clip_vit_l', label: 'CLIP ViT-L/14', type: 'model', verified: true,
    date: '2021', year: 2021,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/openai/clip-vit-large-patch14' }],
  },
  { id: 'controlnet_generic', label: 'controlnet (generic)', type: 'model', verified: false },
  {
    ...
    links: [
      ...
      { label: 'HuggingFace', url: 'https://huggingface.co/h94/IP-Adapter' },
    ],
  },
  {
  ...
  },
  {
    ...
    date: 'October 2022', year: 2022,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/runwayml/stable-diffusion-v1-5' }],
  },
  { id: 'AlphonseMucha', label: 'AlphonseMucha', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'Brushstrokes', label: 'Brushstrokes', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'ColoringBook', label: 'ColoringBook', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'DelicateWhimsy', label: 'DelicateWhimsy', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'EldritchCharcoal', label: 'EldritchCharcoal', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'PixelArt', label: 'PixelArt', type: 'model', verified: false, date: '2023', year: 2023 },
  { id: 'SketchIt', label: 'SketchIt', type: 'model', verified: false, date: '2023', year: 2023 },
  ...
  // ── Datasets ─────────────────────────────────────────────────────────────
  {
    ...
    date: '2022', year: 2022,
    links: [
      { label: 'LAION', url: 'https://laion.ai/blog/laion-5b/' },
      { label: 'HuggingFace', url: 'https://huggingface.co/datasets/laion/laion5b' },
    ],
  },
  {
    id: 'laion2b', label: 'LAION-2B', type: 'dataset', verified: true,
    date: '2022', year: 2022,
    links: [{ label: 'HuggingFace', url: 'https://huggingface.co/datasets/laion/laion2B-en' }],
  },
  {
    id: 'laion_aesthetics', label: 'LAION-Aesthetics v2', type: 'dataset', verified: true,
    date: '2022', year: 2022,
    links: [{ label: 'LAION', url: 'https://laion.ai/blog/laion-aesthetics/' }],
  },
  {
    id: 'midas_ds', label: 'MiDaS depth maps', type: 'dataset', verified: true,
    date: '2019', year: 2019,
    links: [{ label: 'GitHub', url: 'https://github.com/isl-org/MiDaS' }],
  },

  // ── Papers ───────────────────────────────────────────────────────────────
  {
    id: 'sdxl_paper', label: 'Podell et al., SDXL paper', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2307.01952',
    date: 'July 2023', year: 2023,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2307.01952' },
      { label: 'GitHub', url: 'https://github.com/Stability-AI/generative-models' },
    ],
  },
  {
    id: 'clip_paper', label: 'Radford et al., CLIP', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2103.00020',
    date: 'February 2021', year: 2021,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2103.00020' },
      { label: 'GitHub', url: 'https://github.com/openai/CLIP' },
    ],
  },
  {
    id: 'midas_paper', label: 'Ranftl et al., depth estimation', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/1907.01341',
    date: 'July 2019', year: 2019,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/1907.01341' },
      { label: 'GitHub', url: 'https://github.com/isl-org/MiDaS' },
    ],
  },
  {
    id: 'controlnet_paper', label: 'Zhang et al., ControlNet', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2302.05543',
    date: 'February 2023', year: 2023,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2302.05543' },
      { label: 'GitHub', url: 'https://github.com/lllyasviel/ControlNet' },
    ],
  },
  {
    id: 'ipadapter_paper', label: 'Ye et al., IP-Adapter', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2308.06721',
    date: 'August 2023', year: 2023,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2308.06721' },
      { label: 'GitHub', url: 'https://github.com/tencent-ailab/IP-Adapter' },
    ],
  },
  {
    id: 'lora_paper', label: 'Hu et al., LoRA', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2106.09685',
    date: 'June 2021', year: 2021,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2106.09685' },
      { label: 'GitHub', url: 'https://github.com/microsoft/LoRA' },
    ],
  },
  {
    id: 'laion5b_paper', label: 'Schuhmann et al., LAION-5B', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2210.08402',
    date: 'October 2022', year: 2022,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2210.08402' },
      { label: 'Dataset', url: 'https://laion.ai/blog/laion-5b/' },
    ],
  },
  {
    id: 'ldm_paper', label: 'Rombach et al., Latent Diffusion', type: 'paper', verified: true,
    source: 'https://arxiv.org/abs/2112.10752',
    date: 'December 2021', year: 2021,
    links: [
      { label: 'arXiv', url: 'https://arxiv.org/abs/2112.10752' },
      { label: 'GitHub', url: 'https://github.com/CompVis/latent-diffusion' },
    ],
  },
  ...
  // ── Organisations ────────────────────────────────────────────────────────
  {
    ...
    date: 'Founded 2020', year: 2020,
    links: [
      { label: 'stability.ai', url: 'https://stability.ai' },
      { label: 'GitHub', url: 'https://github.com/Stability-AI' },
    ],
  },
  {
    id: 'org_laion', label: 'LAION', type: 'org', verified: true,
    date: 'Founded 2021', year: 2021,
    links: [
      { label: 'laion.ai', url: 'https://laion.ai' },
      { label: 'GitHub', url: 'https://github.com/laion-ai' },
    ],
  },
  {
    id: 'org_openai', label: 'OpenAI', type: 'org', verified: true,
    date: 'Founded 2015', year: 2015,
    links: [
  ...
  },
  {
    ...
    date: 'Founded 2022', year: 2022,
    links: [{ label: 'rundiffusion.com', url: 'https://rundiffusion.com' }],
  },
  {
    id: 'org_tencent', label: 'Tencent AI Lab', type: 'org', verified: true,
    date: 'Founded 1998', year: 1998,
    links: [
      { label: 'AI Lab', url: 'https://ai.tencent.com' },
      { label: 'GitHub', url: 'https://github.com/tencent-ailab' },
    ],
  },
  {
    id: 'org_intel_isl', label: 'Intel ISL', type: 'org', verified: true,
    date: 'Founded 2015', year: 2015,
    links: [{ label: 'GitHub', url: 'https://github.com/isl-org' }],
  },
  {
    id: 'org_microsoft', label: 'Microsoft', type: 'org', verified: true,
    date: 'Founded 1975', year: 1975,
    links: [
      { label: 'Research', url: 'https://www.microsoft.com/en-us/research/' },
      { label: 'GitHub', url: 'https://github.com/microsoft' },
    ],
  },
  {
    id: 'org_runway', label: 'Runway', type: 'org', verified: true,
    date: 'Founded 2018', year: 2018,
    links: [
      { label: 'runwayml.com', url: 'https://runwayml.com' },
      { label: 'GitHub', url: 'https://github.com/runwayml' },
    ],
  },
  {
    ...
    date: 'Founded 2020', year: 2020,
    links: [
      { label: 'ommer-lab.com', url: 'https://ommer-lab.com' },
      { label: 'GitHub', url: 'https://github.com/CompVis' },
    ],
  },
  ...
  // ── People (paper first authors / published model authors) ───────────────
  {
    ...
    date: 'Born ~1988', year: 1988,
    links: [{ label: 'GitHub', url: 'https://github.com/dustinpodell' }],
  },
  {
    id: 'person_radford', label: 'Alec Radford', type: 'person', verified: true,
    date: 'Born ~1991', year: 1991,
    links: [{ label: 'Scholar', url: 'https://scholar.google.com/citations?user=dOad5HoAAAAJ' }],
  },
  {
    id: 'person_zhang', label: 'Lvmin Zhang', type: 'person', verified: true,
    date: 'Born ~1994', year: 1994,
    links: [
      { label: 'Website', url: 'https://lllyasviel.github.io' },
      { label: 'GitHub', url: 'https://github.com/lllyasviel' },
    ],
    photoUrl: 'https://avatars.githubusercontent.com/lllyasviel?v=4',
  },
  {
    id: 'person_ye', label: 'Hu Ye', type: 'person', verified: true,
    date: 'Born ~1995', year: 1995,
    links: [{ label: 'IP-Adapter', url: 'https://github.com/tencent-ailab/IP-Adapter' }],
  },
  {
    id: 'person_hu', label: 'Edward J. Hu', type: 'person', verified: true,
    date: 'Born ~1995', year: 1995,
    links: [{ label: 'Website', url: 'https://edwardjhu.com' }],
  },
  {
    id: 'person_ranftl', label: 'René Ranftl', type: 'person', verified: true,
    date: 'Born ~1990', year: 1990,
    links: [{ label: 'MiDaS', url: 'https://github.com/isl-org/MiDaS' }],
  },
  {
    id: 'person_schuhmann', label: 'Christoph Schuhmann', type: 'person', verified: true,
    date: 'Born ~1987', year: 1987,
    links: [{ label: 'LAION', url: 'https://laion.ai' }],
  },
  {
    id: 'person_rombach', label: 'Robin Rombach', type: 'person', verified: true,
    date: 'Born ~1994', year: 1994,
    links: [{ label: 'Website', url: 'https://ommer-lab.com/people/rombach/' }],
  },
  {
    id: 'person_sg161222', label: 'SG_161222', type: 'person', verified: true,
    date: 'Active 2023', year: 2023,
    links: [
      { label: 'HuggingFace', url: 'https://huggingface.co/SG161222' },
      { label: 'CivitAI', url: 'https://civitai.com/user/SG_161222' },
    ],
  },
];
